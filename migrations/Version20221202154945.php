 ...
 */
final class Version20221202154945 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE trick CHANGE cover_image cover_image VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE trick CHANGE cover_image cover_image VARCHAR(255) NOT NULL');
    }
}
